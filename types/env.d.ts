declare module "@env" {
  export const VITE_TMDB_API_TOKEN: string;
  export const VITE_BACKEND_URL_ANDROID: string;
  export const VITE_BACKEND_URL_IOS: string;
  ...
  export const VITE_FIREBASE_MESSAGE_SENDER_ID: string;
